    ...
    <div class="card mt-4 col-md-8 offset-md-2">
        ...
        @method('PUT')
            <div class="mb-3 form-group">
                ...
                <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $candidat->nom }}" placeholder="nom">
                @error('nom')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="{{ $candidat->prenom }}" placeholder="prenom">
                @error('prenom')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ $candidat->email }}" placeholder="nom@gmail  .com">
                @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="int" class="form-control" name="age" value="{{ $candidat->age }}" placeholder="age">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput5" class="form-label">Niveau Etude</label>
                <input type="text" class="form-control" name="niveauEtude" value="{{ $candidat->niveauEtude }}" placeholder="Niveau Etude">
            </div>
            <label for="exampleFormControlInput6" class="form-label">Sexe</label>
            <div class="mb-3">    
            <select class="form-control" aria-label="Default select example" name="sexe" value="{{ $candidat->sexe }}">
